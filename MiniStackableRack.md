...
Configure credentials via the KVM web UI.
...
**`ply` findings (2026-03-28):**
- Edition: Windows 11 Professional
- License type: `VOLUME_MAK`
- Key: stored in `.env`
...
curl -s -X POST http://${HA_IP}:8123/api/onboarding/users \
  ...
  -d "{\"client_id\":\"http://${HA_IP}:8123/\",\"name\":\"Eduardo Cenci\",\"username\":\"eduardocenci\",\"password\":\"<password>\",\"language\":\"en-US\"}"
```
